...
privileged aspect UserAccountIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserAccountIntegrationTest.testCountUserAccounts() {
        ...
        long count = edu.unlv.cs.rebelhotel.domain.UserAccount.countUserAccounts();
    ...
    public void UserAccountIntegrationTest.testFindUserAccount() {
        ...
        org.junit.Assert.assertEquals("Find method for 'UserAccount' returned the incorrect identifier", id, obj.getId());
    }
    ...
    public void UserAccountIntegrationTest.testFindAllUserAccounts() {
        ...
        java.util.List<edu.unlv.cs.rebelhotel.domain.UserAccount> result = edu.unlv.cs.rebelhotel.domain.UserAccount.findAllUserAccounts();
    ...
    public void UserAccountIntegrationTest.testFindUserAccountEntries() {
        ...
        java.util.List<edu.unlv.cs.rebelhotel.domain.UserAccount> result = edu.unlv.cs.rebelhotel.domain.UserAccount.findUserAccountEntries(0, (int) count);
    ...
    public void UserAccountIntegrationTest.testFlush() {
        ...
        obj.flush();
        org.junit.Assert.assertTrue("Version for 'UserAccount' failed to increment on flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void UserAccountIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUserAccount(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        edu.unlv.cs.rebelhotel.domain.UserAccount merged = (edu.unlv.cs.rebelhotel.domain.UserAccount) obj.merge();
        obj.flush();
