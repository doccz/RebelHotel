...
privileged aspect MajorController_Roo_Controller {
    ...
    public String MajorController.findMajorsByDegreeCodeAndCatalogTermForm(Model uiModel) {
    ...
    public String MajorController.findMajorsByDegreeCodeAndCatalogTerm(@RequestParam("degreeCode") String degreeCode, @RequestParam("catalogTerm") Term catalogTerm, Model uiModel) {
        uiModel.addAttribute("majors", Major.findMajorsByDegreeCodeAndCatalogTerm(degreeCode, catalogTerm).getResultList());
        return "majors/list";
    }
    ...
    public java.util.Collection<Student> MajorController.populateStudents() {
